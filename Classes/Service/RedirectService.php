...
class RedirectService implements LoggerAwareInterface
{
     ...
     */
    public function getTargetUrl(array $matchedRedirect, array $queryParams, $site = null): ?UriInterface
    {
     ...
     * @return UriInterface|null
     */
    protected function getUriFromCustomLinkDetails(array $redirectRecord, $site, array $linkDetails, array $queryParams): ?UriInterface
    {
     ...
     * @return void
     */
    protected function bootFrontendController($site = null, array $queryParams = [])
    {
        // disable page errors
        ...
        $GLOBALS['TSFE']->calculateLinkVars($queryParams);
